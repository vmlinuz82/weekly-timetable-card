 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Dt=globalThis,te=o=>o,at=Dt.trustedTypes,ee=at?at.createPolicy("lit-html",{createHTML:o=>o}):void 0,ae="$lit$",k=`lit$${Math.random().toFixed(9).slice(2)}$`,le="?"+k,io=`<${le}>`,D=document,G=()=>D.createComment(""),W=o=>o===null||typeof o!="object"&&typeof o!="function",Rt=Array.isArray,so=o=>Rt(o)||typeof o?.[Symbol.iterator]=="function",kt=`[ 	
\f\r]`,q=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,oe=/-->/g,re=/>/g,P=RegExp(`>|${kt}(?:([^\\s"'>=/]+)(${kt}*=${kt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ne=/'/g,ie=/"/g,ce=/^(?:script|style|textarea|title)$/i,Lt=o=>(t,...e)=>({_$litType$:o,strings:t,values:e}),p=Lt(1),Jo=Lt(2),Zo=Lt(3),x=Symbol.for("lit-noChange"),h=Symbol.for("lit-nothing"),se=new WeakMap,T=D.createTreeWalker(D,129);function de(o,t){if(!Rt(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return ee!==void 0?ee.createHTML(t):t}var ao=(o,t)=>{let e=o.length-1,r=[],n,i=t===2?"<svg>":t===3?"<math>":"",s=q;for(let a=0;a<e;a++){let l=o[a],c,u,d=-1,f=0;for(;f<l.length&&(s.lastIndex=f,u=s.exec(l),u!==null);)f=s.lastIndex,s===q?u[1]==="!--"?s=oe:u[1]!==void 0?s=re:u[2]!==void 0?(ce.test(u[2])&&(n=RegExp("</"+u[2],"g")),s=P):u[3]!==void 0&&(s=P):s===P?u[0]===">"?(s=n??q,d=-1):u[1]===void 0?d=-2:(d=s.lastIndex-u[2].length,c=u[1],s=u[3]===void 0?P:u[3]==='"'?ie:ne):s===ie||s===ne?s=P:s===oe||s===re?s=q:(s=P,n=void 0);let y=s===P&&o[a+1].startsWith("/>")?" ":"";i+=s===q?l+io:d>=0?(r.push(c),l.slice(0,d)+ae+l.slice(d)+k+y):l+k+(d===-2?a:y)}return[de(o,i+(o[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},X=class o{constructor({strings:t,_$litType$:e},r){let n;this.parts=[];let i=0,s=0,a=t.length-1,l=this.parts,[c,u]=ao(t,e);if(this.el=o.createElement(c,r),T.currentNode=this.el.content,e===2||e===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(n=T.nextNode())!==null&&l.length<a;){if(n.nodeType===1){if(n.hasAttributes())for(let d of n.getAttributeNames())if(d.endsWith(ae)){let f=u[s++],y=n.getAttribute(d).split(k),N=/([.?@])?(.*)/.exec(f);l.push({type:1,index:i,name:N[2],strings:y,ctor:N[1]==="."?St:N[1]==="?"?Et:N[1]==="@"?Pt:j}),n.removeAttribute(d)}else d.startsWith(k)&&(l.push({type:6,index:i}),n.removeAttribute(d));if(ce.test(n.tagName)){let d=n.textContent.split(k),f=d.length-1;if(f>0){n.textContent=at?at.emptyScript:"";for(let y=0;y<f;y++)n.append(d[y],G()),T.nextNode(),l.push({type:2,index:++i});n.append(d[f],G())}}}else if(n.nodeType===8)if(n.data===le)l.push({type:2,index:i});else{let d=-1;for(;(d=n.data.indexOf(k,d+1))!==-1;)l.push({type:7,index:i}),d+=k.length-1}i++}}static createElement(t,e){let r=D.createElement("template");return r.innerHTML=t,r}};function U(o,t,e=o,r){if(t===x)return t;let n=r!==void 0?e._$Co?.[r]:e._$Cl,i=W(t)?void 0:t._$litDirective$;return n?.constructor!==i&&(n?._$AO?.(!1),i===void 0?n=void 0:(n=new i(o),n._$AT(o,e,r)),r!==void 0?(e._$Co??=[])[r]=n:e._$Cl=n),n!==void 0&&(t=U(o,n._$AS(o,t.values),n,r)),t}var wt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:r}=this._$AD,n=(t?.creationScope??D).importNode(e,!0);T.currentNode=n;let i=T.nextNode(),s=0,a=0,l=r[0];for(;l!==void 0;){if(s===l.index){let c;l.type===2?c=new J(i,i.nextSibling,this,t):l.type===1?c=new l.ctor(i,l.name,l.strings,this,t):l.type===6&&(c=new Tt(i,this,t)),this._$AV.push(c),l=r[++a]}s!==l?.index&&(i=T.nextNode(),s++)}return T.currentNode=D,n}p(t){let e=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,e),e+=r.strings.length-2):r._$AI(t[e])),e++}},J=class o{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,r,n){this.type=2,this._$AH=h,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=r,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=U(this,t,e),W(t)?t===h||t==null||t===""?(this._$AH!==h&&this._$AR(),this._$AH=h):t!==this._$AH&&t!==x&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):so(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==h&&W(this._$AH)?this._$AA.nextSibling.data=t:this.T(D.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:r}=t,n=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=X.createElement(de(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===n)this._$AH.p(e);else{let i=new wt(n,this),s=i.u(this.options);i.p(e),this.T(s),this._$AH=i}}_$AC(t){let e=se.get(t.strings);return e===void 0&&se.set(t.strings,e=new X(t)),e}k(t){Rt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,r,n=0;for(let i of t)n===e.length?e.push(r=new o(this.O(G()),this.O(G()),this,this.options)):r=e[n],r._$AI(i),n++;n<e.length&&(this._$AR(r&&r._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let r=te(t).nextSibling;te(t).remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},j=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,r,n,i){this.type=1,this._$AH=h,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=i,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=h}_$AI(t,e=this,r,n){let i=this.strings,s=!1;if(i===void 0)t=U(this,t,e,0),s=!W(t)||t!==this._$AH&&t!==x,s&&(this._$AH=t);else{let a=t,l,c;for(t=i[0],l=0;l<i.length-1;l++)c=U(this,a[r+l],e,l),c===x&&(c=this._$AH[l]),s||=!W(c)||c!==this._$AH[l],c===h?t=h:t!==h&&(t+=(c??"")+i[l+1]),this._$AH[l]=c}s&&!n&&this.j(t)}j(t){t===h?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},St=class extends j{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===h?void 0:t}},Et=class extends j{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==h)}},Pt=class extends j{constructor(t,e,r,n,i){super(t,e,r,n,i),this.type=5}_$AI(t,e=this){if((t=U(this,t,e,0)??h)===x)return;let r=this._$AH,n=t===h&&r!==h||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,i=t!==h&&(r===h||n);n&&this.element.removeEventListener(this.name,this,r),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Tt=class{constructor(t,e,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){U(this,t)}};var lo=Dt.litHtmlPolyfillSupport;lo?.(X,J),(Dt.litHtmlVersions??=[]).push("3.3.3");var pe=(o,t,e)=>{let r=e?.renderBefore??t,n=r._$litPart$;if(n===void 0){let i=e?.renderBefore??null;r._$litPart$=n=new J(t.insertBefore(G(),i),i,void 0,e??{})}return n._$AI(o),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var ko=/[^\p{L}\p{N}]+/gu,wo=/^-+|-+$/g;function So(o){return o.toLowerCase().replace(ko,"-").replace(wo,"")}function Ae(o,t){let e=So(o)||"activity";if(!t.includes(e))return e;let r=2;for(;t.includes(`${e}-${r}`);)r+=1;return`${e}-${r}`}function Ce(o,t){return o.find(e=>e.id===t)}var we=/^(\d{1,2}):(\d{2})$/;function ke(o){try{return new Intl.DateTimeFormat(o,{hour:"numeric"}).formatToParts(new Date(2020,0,1,13,0)).some(e=>e.type==="dayPeriod")}catch{return!1}}var Eo={en:"en-GB",bg:"bg"};function It(o,t){return o?.language??Eo[t]}function Po(o,t){let e=o?.locale?.time_format;if(e==="12")return!0;if(e==="24")return!1;if(e==="system"){let r=typeof navigator>"u"?void 0:navigator.language;return ke(r??It(o,t))}return ke(It(o,t))}function Q(o,t,e){let r=o.trim(),n=we.exec(r);if(!n)return r;let i=Number(n[1]),s=Number(n[2]);if(i>23||s>59)return r;if(!Po(t,e))return`${String(i).padStart(2,"0")}:${n[2]}`;try{return new Intl.DateTimeFormat(It(t,e),{hour:"numeric",minute:"2-digit",hour12:!0}).format(new Date(2020,0,1,i,s))}catch{return r}}var jt=24*60;function Se(o,t){let e=we.exec(o.trim());if(!e)return o;let n=((Number(e[1])*60+Number(e[2])+t)%jt+jt)%jt,i=Math.floor(n/60);return`${String(i).padStart(2,"0")}:${String(n%60).padStart(2,"0")}`}var To="08:00",Do=45;function Kt(o,t,e){return Math.min(Math.max(o,t),e)}function $(o,t,e){return{...o,people:o.people.map((r,n)=>n===t?e:r)}}function H(o,t){return o.schedule[t]??[]}function tt(o,t,e){return{...o,schedule:{...o.schedule,[t]:e}}}function M(o,t){return{...o,...t}}function Ee(o,t){return{...o,people:[...o.people,{name:t,schedule:{}}]}}function Pe(o,t){return o.people.length<=1||!o.people[t]?o:{...o,people:o.people.filter((e,r)=>r!==t)}}function O(o,t,e){let r=o.people[t];if(!r)return o;let n={...r,schedule:{...r.schedule}};if(e.name!==void 0&&(n.name=e.name),e.emoji!==void 0&&(e.emoji===null||e.emoji===""?delete n.emoji:n.emoji=e.emoji),e.color!==void 0&&(e.color===null||e.color===""?delete n.color:n.color=e.color),e.slots!==void 0&&(e.slots===null?delete n.slots:n.slots=e.slots.map(i=>({...i}))),e.days!==void 0){e.days===null||e.days.length===0?delete n.days:n.days=[...e.days];for(let i of n.days??o.days)n.schedule[i]||(n.schedule[i]=[])}return $(o,t,n)}function Ft(o,t,e,r){let n=o.people[t];return n?$(o,t,tt(n,e,[...H(n,e),{...r}])):o}function E(o,t,e,r,n){let i=o.people[t],s=i?.schedule[e]?.[r];if(!i||!s)return o;let a={...s};n.activity!==void 0&&(a.activity=n.activity),n.start!==void 0&&(n.start===null||n.start===""?delete a.start:a.start=n.start),n.end!==void 0&&(n.end===null||n.end===""?delete a.end:a.end=n.end);let l=H(i,e).map((c,u)=>u===r?a:c);return $(o,t,tt(i,e,l))}function Te(o,t,e,r){let n=o.people[t];if(!n||!n.schedule[e]?.[r])return o;let i=H(n,e).filter((s,a)=>a!==r);return $(o,t,tt(n,e,i))}function De(o,t,e,r,n){let i=o.people[t];if(!i)return o;let s=[...H(i,e)];return s.splice(Kt(r,0,s.length),0,{...n}),$(o,t,tt(i,e,s))}function et(o,t,e,r){let n=o.people[t];if(!n)return o;let i=[...H(n,e.day)],s=i[e.index];if(!s)return o;if(i.splice(e.index,1),e.day===r.day)return i.splice(Kt(r.index,0,i.length),0,s),$(o,t,tt(n,e.day,i));let a=[...H(n,r.day)];return a.splice(Kt(r.index,0,a.length),0,s),$(o,t,{...n,schedule:{...n.schedule,[e.day]:i,[r.day]:a}})}function zt(o,t,e,r,n){let i=o.people[t];if(!i)return o;let s=r+n;return s<0||s>=H(i,e).length?o:et(o,t,{day:e,index:r},{day:e,index:s})}function Re(o,t,e){let r=Ae(t,o.activities.map(n=>n.id));return{...o,activities:[...o.activities,{id:r,label:t,color:e}]}}function Vt(o,t,e){return o.activities[t]?{...o,activities:o.activities.map((r,n)=>n===t?{...r,...e}:r)}:o}function Le(o,t){return o.activities[t]?{...o,activities:o.activities.filter((e,r)=>r!==t)}:o}function Be(o,t){let e=0;for(let r of o.people)for(let n of Object.values(r.schedule))for(let i of n??[])i.activity===t&&(e+=1);return e}function He(o,t){let e=o.people[t];if(!e)return o;let r=e.slots??[],i=r[r.length-1]?.end??To,s=r.reduce((a,l)=>Math.max(a,l.slot),0)+1;return $(o,t,{...e,slots:[...r,{slot:s,start:i,end:Se(i,Do)}]})}function Yt(o,t,e,r){let n=o.people[t];return n?.slots?.[e]?$(o,t,{...n,slots:n.slots.map((i,s)=>s===e?{...i,...r}:i)}):o}function Me(o,t,e){let r=o.people[t];return r?.slots?.[e]?$(o,t,{...r,slots:r.slots.filter((n,i)=>i!==e)}):o}function m(o){return o.target.value}function _t(o){return o.target.checked}var Oe="#64748b";function Ne(o){let{config:t,strings:e,commit:r}=o,n=(i,s)=>{let a=Be(t,s.id);if(a>0){let l=`${e.editor.activityInUse(s.label,a)} ${e.editor.confirmRemoveActivity}`;if(!window.confirm(l))return}r(Le(t,i))};return p`
    <div class="panel">
      ...
      <div class="row">
        ...
        <button
          ...
          @click=${i=>{let a=i.currentTarget.parentElement.querySelector('[data-field="new-label"]'),l=a.value.trim();l.length!==0&&(a.value="",r(Re(t,l,Oe)))}}
        >
          +
        </button>
      </div>
  ...
  `}var Ro=5,Ue=56,Lo=14,Bo=16;function Ho(o){let t=o;for(;t;){let e=getComputedStyle(t).overflowY;if((e==="auto"||e==="scroll"||e==="overlay")&&t.scrollHeight>t.clientHeight+1)return t;if(t.parentElement){t=t.parentElement;continue}let r=t.getRootNode();t=r instanceof ShadowRoot?r.host:null}return document.scrollingElement}var Mo="select, input, button, textarea, option, a";function Oo(o,t=!1){let e=o&&o.nodeType!==Node.ELEMENT_NODE?o.parentElement:o,r=e?.closest("[data-drag-block]");if(r){let s=r.dataset.dragDay,a=Number(r.dataset.dragBlock);return w(s)&&Number.isInteger(a)&&a>=0?{kind:"block",day:s,index:a}:null}if(t&&e&&!e.closest(Mo)){let s=e.closest("[data-block-index]"),a=s?.closest("[data-day]")?.dataset.day,l=Number(s?.dataset.blockIndex);if(s&&w(a)&&Number.isInteger(l)&&l>=0)return{kind:"block",day:a,index:l}}let i=e?.closest("[data-palette-activity]")?.dataset.paletteActivity;return i?{kind:"activity",activityId:i}:null}function No(o,t){for(let e=0;e<o.length;e+=1){let r=o[e];if(t<(r.top+r.bottom)/2)return e}return o.length}function Uo(o,t,e){return o.kind!=="block"||o.day!==t?e:e>o.index?e-1:e}var xt=class{constructor(t,e){this.getRoot=t;this.callbacks=e;this._source=null;this._origin={x:0,y:0};this._active=!1;this._hoverDay=null;this._scroller=null;this._scrollTimer=null;this._scrollDirection=0;this.onPointerDown=t=>{if(!t.isPrimary||t.button!==0)return;let e=Oo(t.target,t.pointerType!=="touch");e&&(this._source=e,this._origin={x:t.clientX,y:t.clientY},this._active=!1,this._scroller=Ho(t.target),window.addEventListener("pointermove",this._onPointerMove),window.addEventListener("pointerup",this._onPointerUp),window.addEventListener("pointercancel",this._onPointerCancel))};this._onPointerMove=t=>{if(!this._source)return;if(!this._active){let r=t.clientX-this._origin.x,n=t.clientY-this._origin.y;if(Math.hypot(r,n)<Ro)return;this._active=!0}t.preventDefault(),this._updateAutoScroll(t.clientY);let e=this._dayUnder(t.clientX,t.clientY);e!==this._hoverDay&&(this._hoverDay=e,this.callbacks.requestUpdate())};this._onPointerUp=t=>{let e=this._source,r=this._active;if(this._teardown(),!e||!r)return;let n=this._groupUnder(t.clientX,t.clientY),i=n?.dataset.day;if(!n||!w(i))return;let s=[...n.querySelectorAll("[data-block-index]")].map(l=>{let c=l.getBoundingClientRect();return{top:c.top,bottom:c.bottom}}),a=Uo(e,i,No(s,t.clientY));if(e.kind==="block"){this.callbacks.moveBlock({day:e.day,index:e.index},{day:i,index:a});return}this.callbacks.insertActivity(e.activityId,{day:i,index:a})};this._onPointerCancel=()=>{this._teardown()}}get active(){return this._active}get hoverDay(){return this._hoverDay}cancel(){this._teardown()}_updateAutoScroll(t){let e=this._scroller;if(!e)return;let r=e===document.scrollingElement,n=r?0:e.getBoundingClientRect().top,i=r?window.innerHeight:e.getBoundingClientRect().bottom,s=0;t<n+Ue?s=-1:t>i-Ue&&(s=1),s!==this._scrollDirection&&(this._scrollDirection=s,this._stopAutoScroll(),s!==0&&(this._scrollTimer=setInterval(()=>{e.scrollTop+=s*Lo},Bo)))}_stopAutoScroll(){this._scrollTimer!==null&&(clearInterval(this._scrollTimer),this._scrollTimer=null)}_teardown(){this._stopAutoScroll(),this._scrollDirection=0,this._scroller=null,window.removeEventListener("pointermove",this._onPointerMove),window.removeEventListener("pointerup",this._onPointerUp),window.removeEventListener("pointercancel",this._onPointerCancel);let t=this._active||this._hoverDay!==null;this._source=null,this._active=!1,this._hoverDay=null,t&&this.callbacks.requestUpdate()}_groupUnder(t,e){return(this.getRoot()?.elementFromPoint?.(t,e)??(typeof document.elementFromPoint=="function"?document.elementFromPoint(t,e):null))?.closest("[data-day]")??null}_dayUnder(t,e){let r=this._groupUnder(t,e)?.dataset.day;return w(r)?r:null}};function je(o,t,e){o.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}function K(o){let t=!!o.start,e=!!o.end;return t&&e?"range":e?"until":t?"after":"bare"}function qt(o,t){let e=r=>Q(r,o.hass,o.lang);switch(K(t)){case"range":return o.strings.range(e(t.start),e(t.end));case"until":return o.strings.until(e(t.end));case"after":return o.strings.after(e(t.start));case"bare":return""}}function ot(o,t){let e=Ce(o.config.activities,t.activity),r=qt(o,t),n=e?{"--wtc-block-fill":pt(e.color),"--wtc-block-border":ut(e.color)}:{};return p`
    <div
  ...
  `}function jo(o){return{strings:o.strings,hass:o.hass,lang:S(o.config,o.hass)}}var Ie="#f472b6";function Ke(o,t){let{config:e,strings:r,commit:n}=o,{personIndex:i}=t,s=e.people[i];if(!s)return p``;let a=ht(o.hass),l=Z(e,s);return p`
    <div class="panel">
      <div class="row">
        <input
          type="text"
  ...
  `}function Io(o,t,e){let{config:r,strings:n,commit:i}=o,s=e.slots??[];return p`
  ...
  `}function Ko(o,t,e,r){let{config:n,strings:i,commit:s}=o,{personIndex:a}=t,l=e.schedule[r]??[],c=n.activities[0]?.id;return p`
    ...
    >
      <h4>${i.days[r].full}</h4>
      <div class="block-rows">
        ${l.map((u,d)=>Fo(o,t,r,u,d,l.length))}
        ${c?p`
              <button
                class="chip"
                type="button"
  ...
  `}function Fo(o,t,e,r,n,i){let{config:s,strings:a,commit:l}=o,{personIndex:c}=t,u=s.people[c];return p`
    <div class="row" data-block-index=${n} @click=${d=>d.stopPropagation()}>
      <span class="drag-handle" data-drag-block=${n} data-drag-day=${e}>⠿</span>
      <select
        class="grow"
        data-field="activity"
        @change=${d=>l(E(s,c,e,n,{activity:m(d)}))}
      >
      ...
      ${s.layout==="grid"?zo(o,c,e,r,n,u.slots??[]):p`
            <input
              type="time"
              data-field="start"
              .value=${r.start??""}
              @change=${d=>l(E(s,c,e,n,{start:m(d)||null}))}
            />
            ${r.start?p`
                  <button
                    class="icon-button"
            ...
            <input
              ...
              data-field="end"
              .value=${r.end??""}
              @change=${d=>l(E(s,c,e,n,{end:m(d)||null}))}
            />
            ${r.end?p`
                  <button
                    class="icon-button"
  ...
  `}function zo(o,t,e,r,n,i){let{config:s,strings:a,commit:l}=o,c=K(r)==="range"?i.find(d=>d.start===r.start&&d.end===r.end):void 0,u=c===void 0&&(r.start!==void 0||r.end!==void 0);return p`
    <select
      data-field="slot"
      @change=${d=>{let f=m(d);if(f===""){l(E(s,t,e,n,{start:null,end:null}));return}let y=i.find(N=>String(N.slot)===f);y&&l(E(s,t,e,n,{start:y.start,end:y.end}))}}
    >
    ...
    ${u?p`<span class="hint">${qt(jo(o),r)}</span>`:h}
    ...
    <div class="panel">
      <label class="field">
        ...
        <input
          ...
          data-field="title"
          .value=${t.title??""}
          @change=${i=>r(M(t,{title:m(i)||void 0}))}
        />
      </label>
        ...
        <div class="chips">
          ${n.map(i=>p`
              <button
                ...
                @click=${()=>r(M(t,{days:mt(t.days,i,n)}))}
              >
                ${e.days[i].short}
              </button>
            `)}
      ...
      <label class="field inline">
        <input
          ...
          @change=${i=>r(M(t,{highlight_today:_t(i)}))}
        />
  ...
  `}var A=class extends b{constructor(){super(...arguments);this._tab="settings";this._selectedActivity=null;this._dnd=new xt(()=>this.shadowRoot,{moveBlock:(e,r)=>{let n=this._config;!n||typeof this._tab!="object"||this._commit(et(n,this._tab.person,e,r))},insertActivity:(e,r)=>{let n=this._config;!n||typeof this._tab!="object"||this._commit(De(n,this._tab.person,r.day,r.index,{activity:e}))},requestUpdate:()=>this.requestUpdate()})}setConfig(e){this._config=$t(e),typeof this._tab=="object"&&!this._config.people[this._tab.person]&&(this._tab="settings")}_commit(e){let r=this._config;this._config=e,typeof this._tab=="object"&&(!e.people[this._tab.person]||r!==void 0&&e.people.length<r.people.length)&&(this._tab="settings",this._selectedActivity=null),je(this,"config-changed",{config:e})}disconnectedCallback(){this._dnd.cancel(),super.disconnectedCallback()}render(){let e=this._config;if(!e)return h;let r=ft(S(e,this.hass)),n={config:e,strings:r,hass:this.hass,commit:i=>this._commit(i)};return p`
    ...
    `}_renderPanel(e){return this._tab==="settings"?Fe(e):this._tab==="activities"?Ne(e):Ke(e,{personIndex:this._tab.person,selectedActivity:this._selectedActivity,onSelectActivity:r=>{this._selectedActivity=r},hoverDay:this._dnd.hoverDay})}};A.styles=xe,g([R({attribute:!1})],A.prototype,"hass",2),g([L()],A.prototype,"_config",2),g([L()],A.prototype,"_tab",2),g([L()],A.prototype,"_selectedActivity",2),A=g([lt("weekly-timetable-card-editor")],A);function Gt(o,t){let e=o.strings.days[t];return o.density==="compact"?e.short:e.full}function ze(o){return p`
    <div class="week" style=${v({"--wtc-day-count":String(o.days.length)})}>
      ${o.days.map(t=>Vo(o,t))}
    </div>
  `}function Vo(o,t){let e=o.person.schedule[t]??[];return p`
  ...
  `}function Ve(o){let{config:t,hass:e,density:r,now:n}=o,i=Math.min(Math.max(o.personIndex,0),t.people.length-1),s=t.people[i],a=S(t,e);return{config:t,person:s,days:Z(t,s),strings:ft(a),lang:a,hass:e,density:r,today:t.highlight_today?ve(n):null}}function Ye(o,t){let e=new Map,r=[];for(let n of t){let i=K(n)==="range"?o.find(a=>a.start===n.start&&a.end===n.end):void 0;if(!i){r.push(n);continue}let s=e.get(i.slot);s?s.push(n):e.set(i.slot,[n])}return{bySlot:e,loose:r}}function qe(o){let t=[...o.person.slots??[]].sort((s,a)=>s.slot-a.slot),e=new Map;for(let s of o.days)e.set(s,Ye(t,o.person.schedule[s]??[]));let r=o.days.some(s=>e.get(s).loose.length>0),n=v({"--wtc-day-count":String(o.days.length)}),i=o.days.map(s=>p`<div class=${o.today===s?"grid-head today":"grid-head"}>${Gt(o,s)}</div>`);return p`
